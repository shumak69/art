...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var state = {};
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup-design', '.button-design', 'popup-design');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup-consultation', '.button-consultation', 'popup-consultation');
...
function accordion(buttonsSelector) {
  var btns = document.querySelectorAll(buttonsSelector); // btns.forEach(btn => {
...
function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots;
      var a = input.files[0].name.split('.');
      a[0].length > 6 ? dots = '...' : dots = '.';
      var name = a[0].slice(0, 6) + dots + a[1];
      input.previousElementSibling.textContent = name;

      if (input.closest('.main')) {
        var formData = new FormData();
        formData.append('file', input.files[0]);
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_4__["postData"])('assets/server.php', formData).then(function (data) {
...
function forms(state) {
  ...
  var inputs = document.querySelectorAll('input'); // const phoneInputs = document.querySelectorAll('input[name="user_phone"]');

  var upload = document.querySelectorAll('[name="upload"]'); // phoneInputs.forEach(item => {
...
function openModal(modalSelector, openSelector, closeSubstrate) {
  ...
  modal.addEventListener('click', function (e) {
    if (e.target.classList.contains(closeSubstrate) || e.target.classList.contains('popup-close')) {
...
function picture() {
  var sizeBlock = document.querySelectorAll('.sizes-block');
  var img = document.querySelectorAll('.sizes-block img');
  sizeBlock.forEach(function (item, i) {
    item.addEventListener('mouseover', function () {
      ...
      item.classList.add('animate__animated', 'animate__fadeIn');
      img[i].setAttribute('src', "assets/img/sizes-".concat(i + 1, "-1.png"));
    });
    item.addEventListener('mouseleave', function () {
      ...
      img[i].setAttribute('src', "assets/img/sizes-".concat(i + 1, ".png"));
    });
  });
}
...
function showMoreStyles(button, wrapper) {
  var btn = document.querySelector(button); // cards.forEach(item => {
  //     item.classList.add('animate__animated', 'animate__zoomIn');
  // });
    ...
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(container.appendChild(spinner));

          case 2:
            Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["getResourse"])('../../assets/db.json').then(function (data) {
              return createCards(data.styles);
...
function slider(slides, direction, prev, next) {
  ...
  showSlides(); // function nextSlides {
  //     showSlides();    
  // }
